...
public class MachineBindingCodeActivity_ViewBinding implements Unbinder {
  private MachineBindingCodeActivity target;

  private View view2131755229;

  @UiThread
  public MachineBindingCodeActivity_ViewBinding(MachineBindingCodeActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MachineBindingCodeActivity_ViewBinding(final MachineBindingCodeActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MachineBindingCodeActivity target = this.target;
