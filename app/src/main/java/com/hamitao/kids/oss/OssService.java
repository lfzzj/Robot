...
//                mDisplayer.displayInfo(info);
    ...
    public void delete(String object){
        // 创建删除请求
        DeleteObjectRequest delete = new DeleteObjectRequest(mBucket, object);
        // 异步删除
    ...
    public String getOssConstrainedObjectURL(String objectName) {
        try {
            String url = mOss.presignConstrainedObjectURL(mBucket, objectName, 200 * 60);
            return url;
        } catch (ClientException e) {
            e.printStackTrace();
            return null;
