...
package com.hamitao.kids.record;
...
public class AudioRecordButton extends android.support.v7.widget.AppCompatButton
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        //实例化录音核心类
        mAudioManager = AudioManager.getInstance(FileUtil.getUserChatRecord());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!isRecording || mTime < 1.0f && !mDialogManager.isShowCancelDialog()) {
                    ...
                    if (mListener != null) {// 并且callbackActivity，
                        mListener.onFinished(mTime, mAudioManager.getCurrentFilePath());
                    }
